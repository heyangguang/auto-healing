...
type UserFavorite struct {
	...
	TenantID  *uuid.UUID `json:"tenant_id,omitempty" gorm:"type:uuid;uniqueIndex:idx_user_favorite;index"`
}
...
type UserRecent struct {
	...
	TenantID   *uuid.UUID `json:"tenant_id,omitempty" gorm:"type:uuid;uniqueIndex:idx_user_recent;index"`
}
