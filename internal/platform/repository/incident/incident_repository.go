...
// Create 创建工单
func (r *IncidentRepository) Create(ctx context.Context, incident *platformmodel.Incident) error {
...
// GetByID 根据 ID 获取工单
func (r *IncidentRepository) GetByID(ctx context.Context, id uuid.UUID) (*platformmodel.Incident, error) {
...
// Update 更新工单
func (r *IncidentRepository) Update(ctx context.Context, incident *platformmodel.Incident) error {
...
// List 获取工单列表
func (r *IncidentRepository) List(ctx context.Context, page, pageSize int, pluginID *uuid.UUID, status, healingStatus, severity string, sourcePluginName, search query.StringFilter, hasPlugin *bool, sortBy, sortOrder string, externalID query.StringFilter, scopes ...func(*gorm.DB) *gorm.DB) ([]platformmodel.Incident, int64, error) {
	var incidents []platformmodel.Incident
	var total int64
	q := TenantDB(r.db, ctx).Model(&platformmodel.Incident{})
...
func (r *IncidentRepository) UpsertByExternalID(ctx context.Context, incident *platformmodel.Incident) (bool, error) {
	var existing platformmodel.Incident
...
func buildIncidentSyncUpdates(incident *platformmodel.Incident) map[string]any {
...
func preserveIncidentManagedFields(incoming, existing *platformmodel.Incident) {
...
func (r *IncidentRepository) ListUnscanned(ctx context.Context, limit int) ([]platformmodel.Incident, error) {
	var incidents []platformmodel.Incident
