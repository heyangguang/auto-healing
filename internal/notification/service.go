...
// ListChannels 获取渠道列表
func (s *Service) ListChannels(page, pageSize int, channelType string) ([]model.NotificationChannel, int64, error) {
	return s.repo.ListChannels(page, pageSize, channelType)
}
