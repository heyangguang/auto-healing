...
def validate_openapi(content: str, document: Optional[Dict[str, Any]], errors: List[str]) -> None:
    ...
    require(errors, "/incidents/{id}/restore-trigger:" in content, "openapi 缺少 /incidents/{id}/restore-trigger")
...
def validate_healing_doc(content: str, errors: List[str]) -> None:
    ...
    require(errors, "**POST** `/api/v1/incidents/:id/restore-trigger`" in content, "healing.md 缺少恢复待触发接口")
